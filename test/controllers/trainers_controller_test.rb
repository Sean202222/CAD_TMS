...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference("Trainer.count") do
      post trainers_url, params: { trainer: { address: @trainer.address, dob: @trainer.dob, email: @trainer.email, fname: @trainer.fname, lname: @trainer.lname, phone: @trainer.phone, position: @trainer.position } }
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { address: @trainer.address, dob: @trainer.dob, email: @trainer.email, fname: @trainer.fname, lname: @trainer.lname, phone: @trainer.phone, position: @trainer.position } }
